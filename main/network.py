import quandl ,math  #  if we want to request quandl
import numpy as np  
import pandas as pd
...
#quandl.ApiConfig.api_key ='<GTgjx_yhg_p8LumLgAyt>'
#df = quandl.get("BCHARTS/BITSTAMPUSD")
#df =BCHARTS/BITSTAMPUSD.csv
...
forecast_col = 'Close'
df.fillna(value=-99999, inplace=True) #to fill nulls
